...
// The data heap retains the modern size-threshold shuffle and its free guard.
// Code uses a separately admitted per-class reservoir, including large bodies.
...
typedef ANSIWrapper<CodeShuffleHeap<KingsleyHeap<CodeSource, CodeSource>, RandomNumberGenerator> > CodeHeapType;
